document.addEventListener('DOMContentLoaded', async () => {
    ...
    const pageCurrentId = document.getElementById('page-current-id')?.dataset.id;
if (!pageCurrentId) {
    console.error('ID da página não encontrado.');
    return;
}
    ...
    const loadFlashcardsList = async () => {
        try {
            const response = await fetch(`/flashcards/${pageCurrentId}/list/`, {
                method: 'GET',
                headers: {
    ...
    const selectFlashcard = async (event, flashcardId) => {
        ...
        try {
            ...
            const response = await fetch(`/flashcards/${pageCurrentId}/select/`, {
                method: 'POST',
                headers: {
                    'x-requested-with': 'XMLHttpRequest',
    ...
    const sendAction = async (action) => {
        try {
            ...
            const response = await fetch(`/flashcards/${pageCurrentId}/interaction/`, {
                method: 'POST',
                headers: {
                    'X-CSRFToken': csrfToken,
                    'x-requested-with': 'XMLHttpRequest',
...
const assignDifficulty = async (difficulty) => {
    ...
    try {
        ...
        const response = await fetch(`/flashcards/${pageCurrentId}/difficulty/`, {
            method: 'POST',
            headers: {
                'x-requested-with': 'XMLHttpRequest',
                'X-CSRFToken': csrfToken,
